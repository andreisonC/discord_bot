...
class MyClient(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if message.content == '!regras':
            ...
            await message.channel.send(f'Olá{message.author.name}, aqui está o link: {os.linesep} https://docs.google.com/forms/d/e/1FAIpQLSe00bqxHPIDYlwcMmtt_iKsddci1EAqHf_UdK8K7NzQFBkFGQ/viewform?usp=sf_link {os.linesep}Qualquer duvida, digite !ajudarecrut')
